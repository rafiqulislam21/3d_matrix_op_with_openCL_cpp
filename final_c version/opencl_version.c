...
int main(int argc, char ** argv) {
	...
	cl_mem cMemObj = clCreateBuffer(context, CL_MEM_READ_WRITE, SIZE * sizeof(float), NULL, &ret);
	...
	ret = clEnqueueWriteBuffer(commandQueue, cMemObj, CL_TRUE, 0, SIZE * sizeof(float), C, 0, NULL, NULL);
